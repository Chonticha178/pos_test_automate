...
def run_smart_scenario(main_window, config):
    try:
        ...
        # 3. ข้อมูลเพิ่มเติม (สำหรับส่วนท้ายที่เพิ่มเข้ามา)
    ...
    # --- ส่วนที่เชื่อมต่อกับโค้ดตัวอย่าง (Flow ต่อจากนี้) ---
    ...
    # --- เรียกใช้ฟังก์ชันจากโค้ดตัวอย่างตามลำดับ ---
